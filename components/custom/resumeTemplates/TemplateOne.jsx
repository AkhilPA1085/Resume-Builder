    ...
    <div className="text-[11px] font-sans text-[#333] leading-[1.4] print:text-black print:bg-white">
      ...
      >
        ...
        <div className="text-center mb-6 border-b-2 border-[#2c3e50] pb-4">
          <div className="text-[28px] font-bold text-[#2c3e50] mb-1 uppercase">
            {personalInfo?.name}
          </div>
        ...
        <div className="flex gap-6">
          ...
          <div className="w-1/3 space-y-6">
            ...
            {hasValues(skills) && (
              <section>
                <h2 className="text-[13px] font-bold uppercase text-[#2c3e50] ">
                  Skills
                </h2>
          ...
          <div className="w-2/3 space-y-6">
            ...
            {hasValues(summary) && (
              <section>
                ...
                <p className="text-justify">{summary?.personalSummary}</p>
              </section>
            )}

            {/* Experience */}
            {hasValues(experience) && (
              <section>
                <h2 className="text-[13px] font-bold uppercase text-[#2c3e50] ">
                ...
                {experience?.map((job, idx) => (
                  <div key={idx} className="mb-4">
                    <div className="font-bold text-[12px] text-[#2c3e50]">
                      {job.jobTitle}
                    </div>
                    <div className="italic text-[11px] text-[#7f8c8d]">
                      {job.company}
                    </div>
                    <div className="text-[10px] text-[#95a5a6]">
                      {job.expDuration}
                    </div>
                    <div className="text-[10px] text-[#95a5a6] mb-1">
                      {job.expLocation}
                    </div>
