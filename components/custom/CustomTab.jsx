...
export default function CustomTab() {
  ...
  const validate = () => {
    ...
    formData.education.forEach((edu, index) => {
      if (!edu.degree.trim()) {
        errs[`education_${index}_degree`] = "Degree is required";
      }
      if (!edu.stream.trim()) {
        errs[`education_${index}_stream`] = "Stream is required";
      }
      if (!edu.university.trim()) {
        errs[`education_${index}_university`] = "University is required";
      }
      if (!edu.duration.trim()) {
        errs[`education_${index}_duration`] = "Duration is required";
      }
      if (!edu.location.trim()) {
        errs[`education_${index}_location`] = "Location is required";
      }
    });
